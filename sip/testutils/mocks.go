...
func (tpl *MockTransportLayer) Listen(network string, addr string, options ...any) error {
	return nil
}
...
func (tpl *MockTransportLayer) String() string {
	...
	return fmt.Sprintf("testutils.MockTransportLayer<%s>", tpl.Fields())
}

func (tpl *MockTransportLayer) Fields() log.Fields {
	return tpl.fields
}
