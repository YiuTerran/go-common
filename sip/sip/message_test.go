			...
			sip.NewRequest(
				...
				[]sip.Header{
					...
					&sip.FromHeader{
						...
						Params: sip.NewParams(sip.HeaderParams).Add("tag", sip.String{"qwerty"}),
					},
					&callId,
				},
				"test",
	...
	doTests([]stringTest{
		...
		},
		{
			...
			&sip.SipUri{
				FUser:      sip.String{"alice"},
				FHost:      "wonderland.com",
				FUriParams: sip.NewParams(sip.UriParams).Add("food", sip.String{"cake"}),
				FHeaders:   nil,
			},
		...
		},
		{
			...
			&sip.SipUri{
				FUser:      sip.String{"alice"},
				FHost:      "wonderland.com",
				FUriParams: sip.NewParams(sip.UriParams).Add("something", nil),
				FHeaders:   nil,
			},
		...
		},
		{
			...
			&sip.SipUri{
				...
				FHost:      "wonderland.com",
				FUriParams: nil,
				FHeaders:   sip.NewParams(sip.UriHeaders).Add("CakeLocation", sip.String{"Tea Party"}),
			},
			"sip:alice@wonderland.com?CakeLocation=Tea%20Party",
		},
		{
			...
			"sip:alice@wonderland.com?CakeLocation=Tea%20Party&Identity=Mad%20Hatter&OtherHeader=Some%20value",
		},
		{
			...
			"sip:alice@wonderland.com;food=cake?CakeLocation=Tea%20Party",
		},
		{
			"Wildcard URI",
			&sip.WildcardUri{},
	...
	doTests([]stringTest{
		...
		},
		{
			...
			&sip.ToHeader{
				...
				Params: sip.NewParams(sip.HeaderParams).Add("food", sip.String{"cake"}),
			},
		...
		},
		{
			...
			sip.ViaHeader{
				...
				&sip.ViaHop{
					...
					Transport:       "UDP",
					Host:            "oxford.co.uk",
					Params:          sip.NewParams(sip.HeaderParams).Add("delicious", nil),
				},
			},
