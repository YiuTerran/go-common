...
// RequestMethod is a representation of a SIP method.
...
// Equals determine if the given method equals some other given method.
...
func (hs *headers) String() string {
	...
	for _, name := range hs.headerOrder {
		for _, header := range hs.headers[name] {
...
// GetHeaders return headers by name
...
func (msg *message) Fields() log.Fields {
	...
	return log.MergeFields(msg.fields, log.Fields{
		"transport":   msg.tp,
		"source":      msg.src,
