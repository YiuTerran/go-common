...
`,
		Session: &Session{
			...
			Timing: &Timing{
				Start: parseTime("1996-02-27 15:26:59 +0000 UTC").Unix() + UnixTimeOffset,
				Stop:  parseTime("1996-05-30 16:26:59 +0000 UTC").Unix() + UnixTimeOffset,
			},
			Repeat: []*Repeat{
				{
			...
			TimeZone: []*TimeZone{
				{Time: parseTime("1996-02-27 15:26:59 +0000 UTC").Unix() + UnixTimeOffset, Offset: -time.Hour},
				{Time: parseTime("1996-05-30 16:26:59 +0000 UTC").Unix() + UnixTimeOffset, Offset: 0},
			},
			Mode: ModeRecvOnly,
			Media: []*Media{
				{
...
func (t *T) AssertAny(name string, got, exp any) {
...
func (t *T) Assert(name string, got, exp any) {
