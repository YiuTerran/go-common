...
//copy from smallnest/chanx
// 这个ringbuffer是一个无限增长的版本
...
// It is not thread-safe(goroutine-safe) so you must use the lock-like synchronization
// primitive to use it in multiple writers and multiple readers.
