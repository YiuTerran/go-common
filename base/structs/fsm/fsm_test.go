...
func TestStates(t *testing.T) {
	state1 := State{
		...
		Outcomes: map[Input]Outcome{
			test_input_1: Outcome{test_state_2, NoAction},
			test_input_2: Outcome{test_state_3, NoAction},
			test_input_3: Outcome{test_state_1, NoAction},
		},
	}
	state2 := State{
		Index: test_state_2,
		Outcomes: map[Input]Outcome{
			test_input_1: Outcome{test_state_1, NoAction},
			test_input_2: Outcome{test_state_1, NoAction},
			test_input_3: Outcome{test_state_1, NoAction},
		},
	}
	state3 := State{
	...
	state1 := State{
		...
		Outcomes: map[Input]Outcome{
			...
			test_input_2: Outcome{test_state_3,
				func() Input { func3_hit = true; return NoInput }},
			test_input_3: Outcome{test_state_1, NoAction},
		},
	}
	state2 := State{
...
func TestImpossibleState(t *testing.T) {
	...
	var stateError ImpossibleStateError
	if errors.As(err, &stateError) {
		t.Logf("FSM corrently returned error: %s", err.Error())
	} else {
